...
namespace Deployment {
  ...
  static const Svc::TlmPacketizerChannelEntry MathSenderList[] = {
      {3584, 4}, // mathSender.VAL1
      {3585, 4}, // mathSender.OP
      {3586, 4}, // mathSender.VAL2
      {3587, 4}, // mathSender.RESULT
  };

  static const Svc::TlmPacketizerPacket MathSender = { MathSenderList, 21, 3, FW_NUM_ARRAY_ELEMENTS(MathSenderList) };
