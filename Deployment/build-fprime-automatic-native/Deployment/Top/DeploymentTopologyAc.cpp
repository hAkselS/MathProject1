...
namespace Deployment {
  ...
  MathModule::MathReceiver mathReceiver(FW_OPTIONAL_NAME("mathReceiver"));

  MathModule::MathSender mathSender(FW_OPTIONAL_NAME("mathSender"));
  ...
  void startTasks(const TopologyState& state) {
    ...
    mathSender.start(
      static_cast<NATIVE_UINT_TYPE>(Priorities::mathSender),
      static_cast<NATIVE_UINT_TYPE>(StackSizes::mathSender),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<NATIVE_UINT_TYPE>(TaskIds::mathSender)
    );
    prmDb.start(
